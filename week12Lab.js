...
function updateUser() { 
  ...
  const requestOptions = {
      ...
      body: JSON.stringify({  fullName: $('#fullNameUpdate').val(), researchAssignment: $('#newAssignmentUpdate').val() })
  };

  //alert(requestOptions.body);

  fetch(STUDENT_ROSTER_URL + '/' + $('#idUpdate').val(), requestOptions)
